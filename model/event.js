...
const eventSchema = new Schema({
    ...
    sporttype : {type:String,required:[true,'categorytype is required'],enum:['ICC Tournaments','Leagues','Domestic Cricket','Youth Cricket','Recreational and Informal Cricket']},
